...
Company objC = new Company( "IBM" );
objC.Add( new Employee() { Id = 1, Name = "Something", Designation = "Clerk", Salary = 1000M } );
objC.Add( new Employee() );

int[] arr = new int[5] { 1, 2, 3, 4, 5 };           // Collection Initialization
...
// Naming Convention of Event Handler: OBJECT_EVENTNAME
