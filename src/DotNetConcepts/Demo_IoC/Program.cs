...
p2.DoSomething( X.MyCustomStep2 );              // send the callback delegate
Console.WriteLine();
...
p2b1.eventHandler += X.MyCustomStep2;           // subscribe to the event.
p2b1.DoSomethingByEvent();

Console.WriteLine();

Console.WriteLine( "--- demo of IoC using Events - Eg 2 (with anonymous method)" );
